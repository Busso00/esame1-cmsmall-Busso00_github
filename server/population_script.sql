...
VALUES  ("localhost:80/static/pizza.png"),
		("localhost:80/static/sport.png"),
		("localhost:80/static/CSS.png"),
		("localhost:80/static/ADC.png");
...
VALUES  (1,0,0,NULL,"Pizza",NULL),
		...
		(1,1,2,NULL,NULL,"localhost:80/static/pizza.png"),
		(4,2,2,NULL,NULL,"localhost:80/static/sport.png"),
		(5,2,2,NULL,NULL,"localhost:80/static/CSS.png"),
		(6,3,2,NULL,NULL,"localhost:80/static/ADC.png");
